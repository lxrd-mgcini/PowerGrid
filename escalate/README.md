To install this module, drop the entire escalate folder into one of your module directories. The default PowerGrid module paths are listed in the $Env:PSModulePath environment variable.
